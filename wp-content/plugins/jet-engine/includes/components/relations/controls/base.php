...
class Base {
	...
	public function get_control_title() {
		...
		if ( $label ) {
			...
			$args = $this->get_args();
			return jet_engine()->relations->types_helper->get_relation_label( $this->relation, $args['object_type'], $args['object_name'] );
		}
	...
	public function get_el_id() {
		$args = $this->get_args();
		return 'jet_engine_rel_' . $this->relation->get_id();
	}
